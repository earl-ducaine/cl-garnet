...
@i(ACM Transactions on Computer-Human Interaction).  To appear.
...
@i(ACM Transactions on Computer-Human Interaction).  Vol. 1, no. 2,
To appear.

Brad A. Myers.  ``Challenges of HCI Design and Implementation,''
@i(ACM Interactions).  Vol. 1, no. 1.  January, 1994.  pp. 73-83.
...
Brad Vander Zanden, Brad A. Myers, Dario Giuse and Pedro Szekely.
``Integrating Pointer Variables into One-Way Constraint Models,''
@i(ACM Transactions on Computer-Human Interaction).  Vol. 1, no.
2, June, 1994. pp. 161-213.



@blankspace(1 line)
@b(Refereed Conference Articles)

Brad A. Myers. ``The Garnet User Interface Development Environment:
Demonstration Abstract.'' @i(CHI'94 Conference Companion).  Boston,
MA, Apr. 24-28, 1994. pp. 25-26.

Brad A. Myers and Dan R. Olsen, Jr. ``User Interface Tools: Tutorial
Description'' @i(CHI'94 Conference Companion).  Boston, 
...
Video Abstract,'' @i(CHI'94 Conference Companion).  Boston, MA, Apr.
...
Interfaces?''  @i(ACM Symposium on User Interface Software and
...
@blankspace(1 line)
@b(Refereed Published Videotapes)

Brad A. Myers, Dario Giuse, Andrew Mickish, Brad Vander Zanden, David
Kosbie, Richard McDaniel, James Landay, Matthew Goldberg, and Rajan
Parthasarathy. @i(The Garnet User Interface Development Environment).
Technical Video Program of the CHI'94 conference.
@i[SIGGRAPH Video Review], Issue 97, no. 13.
...
Brad A. Myers. ``User Interface Software,'' @i(Encyclopedia of Computer
...
Brad A. Myers.  @i(User Interface Software Tools). Carnegie Mellon University
...
James A. Landay and Brad A. Myers.  @i(Interactive Sketching for the
...
@i(Making Structured Graphics and Constraints Practical for
