...
;;      scroll bar in the window.  to run it, enter
;;      garnet-gadgets:v-scroll-go To stop, enter
;;      garnet-gadgets:v-scroll-stop
...
(defun v-scroll-go ()
  ...
  (s-value v-scroll-win
	   ...
	   (create-instance 'v-scroll-top-agg opal:aggregate
	     (:overlapping T)))
  ;; one of these two seem to be causing problems when trying to
  ;; reinstantiate.
