...
;; document name to be the filename the gadget returns, v, and calls
;; Write-Draw-Agg, which does the saving.
...
(defun darnetdraw (&key dont-enter-main-event-loop double-buffered-p)
