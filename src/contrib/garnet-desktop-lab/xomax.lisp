;;; -*- Mode: LISP; Syntax: Common-Lisp; Package: DEMO-MULTIFONT;  -*-
...
;; This is used in the "Size" menu.  It changes the size attribute of
;; the current font.
...
;; "Paste" selection of the "Edit" menu.  Copy whatever is in the cut
...
;; "Italic" selection of the "Edit" menu.  Toggle the current font to
;; be italic.
...
;; "Font Smaller" selection of the "Edit" menu: toggle the current
;; font to be one size smaller.
...
;; "Toggle Lisp Mode" selection of the "Edit" menu: toggle the
...
;; Do-stop kills the parent window which will destroy all internal
;; garnet objects and gadgets.
(defun Do-Stop ()
